...
function Partner() {
  return (
    <div className="bg-black mt-[10%] h-[35rem]">
      <h1 className="text-5xl font-medium text-yellow-600 text-center mt-5">
        Our Patrners
      </h1>
      <p className="text-center ml-[30%]  mt-8 text-white text-md font-medium lg:w-[32rem] md:w-[20rem]">
      ...
      <div className="ml-[20%] mt-12">
        ...
        <div className="ml-[10%] grid grid-cols-3 mt-10">
          <div className="bg-white h-[8rem] w-[8rem] rounded-md">
            <img src={obj.disney} alt="" className="self-center py-4" />
          </div>
          <div className="bg-white h-[8rem] w-[8rem] rounded-md">
            {" "}
